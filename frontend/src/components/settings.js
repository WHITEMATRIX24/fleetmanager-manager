      ...
      <div className="left-section-settings">
        ...
        <div className="settings-manager-div">
          <div className="settings-manager">
            {" "}
            <h3> Username: {managerUsername}</h3>
          </div>
          <div>
            <button
              className="settings-passwordchange"
        ...
        <div className="theme-option">
          ...
          <div
            className={`toggle-switch ${
              theme === "navy-blue-theme" ? "on" : "off"
            }`}
            onClick={() => handleThemeChange("navy-blue-theme")}
          >
            <div className="switch"></div>
