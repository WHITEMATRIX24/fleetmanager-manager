  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch(
        `http://13.50.175.179:5000/api/updatedriver`,
        {
          method: "POST",
          headers: {
  ...
  return (
    <div className="popup-form-overlay-driv">
      <div className="popup-form-container-driv">
        <span className="close-popup-driv" onClick={onClose}>
          &times;
        </span>
        <form className="popup-form-driv" onSubmit={handleSubmit}>
          ...
          <div className="popup-form-field-row-driv">
            <div
              className="popup-form-field-column-driv"
              style={{ width: "25%" }}
            >
          ...
          <button type="submit" className="popup-submit-button-driv">
            Submit
          </button>
        </form>
        {alertMessage && (
